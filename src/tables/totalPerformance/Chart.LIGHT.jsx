            ...
            <div>
                <ChartCanvas ratio={ratio} width={width} height={300}
                    ...
                    <Chart id={0} yExtents={d => d.close}>
                        ...
                        <XAxis axisAt="bottom" orient="bottom" ticks={6} stroke="rgba(216,216,216, 1)"
                               tickStroke='#67809F' {...xGrid}/>
                        <YAxis axisAt="left" orient="left" percentScale={true} stroke="rgba(0,0,0, 0)"
                               tickStroke='#67809F' {...yGrid} />
