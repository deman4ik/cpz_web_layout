            ...
            >
                ...
                >
                    ...
                    <MouseCoordinateY
                        ...
                        fill={'#40DDFF'}
                        itemType="first"
                        lineStroke={'#40DDFF'} lineOpacity={1} textFill={'#242B4A'} fontSize={14}
                    ...
                    <EdgeIndicator itemType="first" orient="right" edgeAt="right"
                                   yAccessor={ema20.accessor()} fill={'#1CA46B'}  lineStroke={'#1CA46B'} lineOpacity={1} textFill={'#242B4A'} fontSize={14} />
                    <EdgeIndicator itemType="first" orient="right" edgeAt="right"
                                   yAccessor={ema50.accessor()} fill={'#CD3E60'} lineStroke={'#CD3E60'} lineOpacity={1} textFill={'#242B4A'} fontSize={14}/>
                    ...
                    {/*<EdgeIndicator itemType="first" orient="left" edgeAt="left"*/}
                                   {/*yAccessor={d => d.close} fill={d => d.close > d.open ? "#1CA46B" : "#FF0000"}/>*/}
