    ...
    render() {
        return (
            <div className="robots_container">
                ...
                <RobotsElement color={this.colorScale} color2={this.colorScale2}  robot_name={'Robot  Name'} coin_name={'ETH'} coin_class={'coin_icon_eth'}
                ...
                <RobotsElement color={this.colorScale}  color2={this.colorScale2} robot_name={'Robot  Name'} coin_name={'XRP'} coin_class={'coin_icon_RIPPLE'}
                ...
                <RobotsElement color={this.colorScale} color2={this.colorScale2}  robot_name={'Robot  Name'} coin_name={'BTC'} coin_class={'coin_icon_bitcoin'}
                               exchange={'OKEX'} initial_capital={'13.87365489'} initial_capital_old={'13.87365489'}
                               robot_balance={'13.87365489 ETH'} robot_balance_old={'13.87365489'}
                               performance_val={'+ 3,90%'} performance_val_old={'+ 3,90%'}
